...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Column Mapping', href: '/leads/import/mapping' },
];
...
export default function MappingLeads({
    batchId,
    filename,
    headers,
    sampleRows,
    ...
    const STORAGE_KEY = 'lead_import_mappings';
            ...
            <div className="max-w-6xl p-4">
                <div className="mb-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                        Match the columns in your file to lead fields. Required fields are marked with *.
                    </p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button asChild variant="outline">
                            <Link href="/leads/import">Cancel</Link>
                        </Button>
                    </div>
                </form>
            </div>
