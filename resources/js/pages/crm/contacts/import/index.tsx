...
export default function ImportContacts({ recentBatches }: Props) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-4xl p-4">
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground text-sm">Upload a CSV or Excel file to import multiple contacts at once.</p>
                </div>
                ...
                <div className="bg-card mb-8 space-y-4 rounded-lg border p-6 shadow-xs">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button asChild variant="outline" size="sm">
                            <a href="/contacts/import-template/xlsx" download>
                                <Download className="mr-2 h-4 w-4" />
                                Excel Template
                            </a>
                        </Button>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        {batch.status !== 'pending' && (
                                            <Button asChild variant="ghost" size="sm">
                                                <Link href={`/contacts/import/${batch.id}`}>View</Link>
                                            </Button>
                                        )}
                                    </div>
                                </div>
