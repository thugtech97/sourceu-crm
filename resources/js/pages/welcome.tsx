    ...
    const features = [
        {
            ...
            desc: 'Drag-and-drop deal board across Lead, Proposal, Negotiation, and Closing stages — visual deal management at a glance.',
        },
        {
            icon: '🏢',
            title: 'Account Management',
            desc: 'Full company profiles with linked contacts, deal history, activity logs, and notes — everything before the call.',
        },
        {
            icon: '👥',
            title: 'Contact Management',
            desc: 'Manage leads and clients with detailed profiles, linked accounts, call history, tags, and dispositions.',
        },
        {
            icon: '📞',
            title: 'Dialpad Integration',
            desc: 'Dial any contact with one click from the CRM. Call logs sync automatically to the contact timeline.',
        },
        {
            icon: '🎯',
            title: 'Lead Pool',
            desc: 'Claim open leads from the shared pool, set dispositions, and release unworked leads — built for the team workflow.',
        },
        {
            icon: '🚫',
            title: 'DNC Management',
            desc: 'Maintain a Do-Not-Call list that protects the team from compliance issues and prevents duplicate outreach.',
        },
        {
            icon: '🔔',
            title: 'Smart Notifications',
            desc: 'Stay on top of deal updates, stage changes, and team activity with real-time in-app alerts.',
        },
        {
            icon: '🔗',
            title: 'Webhook Integrations',
            desc: 'Connect with Zapier and Dialpad via webhooks. Automate lead capture and sync call data without manual entry.',
        },
        {
            icon: '📊',
            title: 'Dashboard Analytics',
            desc: 'Track your pipeline value, deal counts, and team performance from a single overview dashboard.',
        },
    ];
    ...
    const whoUses = [
        {
            icon: '🧑‍💼',
            title: 'Sales Team',
            desc: 'Own your pipeline. Track leads from first contact to signed contract without switching between tools.',
        },
        {
            icon: '🤝',
            title: 'Partnerships',
            desc: 'Manage partner relationships, track joint opportunities, and keep communication centralized.',
        },
        {
            icon: '👤',
            title: 'Account Management',
            desc: 'Stay on top of existing clients. Log interactions, flag renewals, and spot upsell opportunities early.',
        },
        {
            icon: '📊',
            title: 'Leadership & Ops',
            desc: 'Real-time view of team performance, revenue pipeline, and deal health across the organization.',
        },
    ];

    const steps = [
        { title: 'Request access', desc: 'Fill in a quick form with your SourceU email. Your manager will approve access within 24 hours.' },
        { title: 'Set up your profile', desc: 'Add your role, team, and notification preferences to personalize your workspace.' },
        { title: 'Import your contacts', desc: 'Bring in existing leads and clients or let webhook integrations feed them in automatically.' },
        ...
        <>
            ...
            <div>
                ...
                <div className={`mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
                    ...
                    <a href="#who" onClick={() => setMobileMenuOpen(false)}>Who Uses It</a>
                    <a href="#access" onClick={() => setMobileMenuOpen(false)}>Get Access</a>
                    <div className="mob-divider" />
                    <div className="mob-actions">
                        <a href="/login" className="btn-ghost" onClick={() => setMobileMenuOpen(false)}>Sign In</a>
                        <a href="/register" className="btn-fill" onClick={() => setMobileMenuOpen(false)}>Request Access</a>
                    </div>
                </div>
                ...
                <section className="hero">
                    <div className="hero-left">
                        ...
                        <p>
                            Manage client relationships, track your pipeline, and close more deals — all in one place, built specifically for how SourceU works.
                        </p>
                        <div className="hero-actions">
                            <a href="/login" className="btn-hero">Open CRM</a>
                            <a href="#features" className="btn-link">Explore features <span>→</span></a>
                        </div>
                    </div>
                    ...
                    <div className="hero-right">
                        <div className="mockup-card">
                            <div className="mockup-topbar">
                                ...
                                <span className="mockup-title">SourceU CRM · Kanban Pipeline</span>
                            </div>
                            <div className="mockup-body">
                                ...
                                <div className="mock-pipeline-label">Kanban Board</div>
                ...
                <div className="stats-bar">
                    <div className="stats-inner">
                        {[
                            { to: 9, suffix: '+', label: 'Core Features' },
                            { to: 3, suffix: '', label: 'Live Integrations' },
                            { to: 5, suffix: '', label: 'Teams Using It' },
                            { to: 100, suffix: '%', label: 'Built for SourceU' },
                        ].map((s, i) => (
                            <div key={i} data-animate data-d={String(i + 1)}>
                ...
                {/* DEPT PILLS */}
                <div className="dept-section" data-animate>
                    <span className="dept-text">Used across ·</span>
                    <div className="dept-pills">
                        {['🧑‍💼 Sales', '📣 Marketing', '🤝 Partnerships', '👤 Account Mgmt', '📊 Operations', '👩‍💼 Leadership'].map(
                            (d, i) => (
                                <span className="dept-pill" key={i}>
                                    {d}
                                </span>
                            ),
                        )}
                ...
                <section className="section" id="features">
                    <div data-animate>
                        ...
                        <div className="section-title">
                            Everything your team needs to <span>close deals</span>
                        </div>
                    </div>
                    <div className="features-grid">
                        {features.map((f, i) => (
                            <div className="feat-card" key={i} data-animate data-d={String((i % 3) + 1)}>
                ...
                {/* INTEGRATIONS */}
                <section className="section" id="integrations" style={{ paddingTop: '0' }}>
                    <div data-animate>
                        <div className="section-eyebrow">Integrations</div>
                        <div className="section-title">
                            Connected to the <span>tools you use</span>
                        </div>
                    </div>
                        ...
                        {[
                            {
                                icon: '📞',
                                name: 'Dialpad',
                                desc: 'Click-to-call from any contact. Call logs auto-sync to the CRM timeline.',
                            },
                            {
                                icon: '⚡',
                                name: 'Zapier',
                                desc: 'Automate lead capture and cross-tool workflows with zero code.',
                            },
                            {
                                icon: '🔗',
                                name: 'Webhooks',
                                desc: 'Custom endpoints for inbound leads, deal updates, and automations.',
                            },
                        ].map((int, i) => (
                            <div className="int-card" key={i} data-animate data-d={String(i + 1)}>
                                <div className="int-icon">{int.icon}</div>
                                <div className="int-info">
                                    <h4>{int.name}</h4>
                                    <p>{int.desc}</p>
                                </div>
                                <span className="int-badge">Live</span>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <section className="section" id="who" style={{ paddingTop: '0' }}>
                    <div data-animate>
                        ...
                        <div className="section-title">
                            Built for every <span>SourceU</span> team
                        </div>
                    </div>
                    <div className="who-grid">
                        {whoUses.map((w, i) => (
                            <div className="who-card" key={i} data-animate data-d={String((i % 2) + 1)}>
                ...
                <section className="section" style={{ paddingTop: '0' }}>
                    ...
                    <div className="steps-list">
                        {steps.map((s, i) => (
                            <div className="step-row" key={i} data-animate data-d={String(i + 1)}>
                ...
                <div className="access-section" id="access">
                    <div className="access-inner" data-animate>
